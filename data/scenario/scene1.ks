...
[playbgm  volume="100"  time="1200"  loop="true"  storage="MusMus-BGM-047.mp3"  fadein="true"  ]
...
[mask  time="1000"  effect="fadeIn"  color="0x000000"  ]
[stopbgm  time="1000"  ]
[playbgm  volume="100"  time="1000"  loop="true"  storage="MusMus-BGM-043.mp3"  fadein="true"  ]
...
[playbgm  volume="100"  time="1000"  loop="true"  storage="MusMus-BGM-065.mp3"  fadein="true"  ]
...
[playbgm  volume="100"  time="1000"  loop="true"  storage="MusMus-BGM-072.mp3"  fadein="true"  ]
[tb_start_text mode=1 ]
#老人
確かにここは発展してきているけど、[p]
実は問題もあるんじゃ。[p]
...
[playbgm  volume="100"  time="1000"  loop="true"  fadein="true"  storage="MusMus-BGM-093.mp3"  ]
[chara_hide  name="老人"  time="1000"  wait="true"  pos_mode="true"  ]
[tb_start_text mode=1 ]
#羽蘭
はい！[p]
...
[playse  volume="100"  time="1000"  buf="0"  storage="kuizu3.mp3"  ]
[tb_start_text mode=1 ]
#みどり
モンゴルの首都は何でしょう？？[p]
[_tb_end_text]
...
[playse  volume="100"  time="1000"  buf="0"  storage="kuizu4.mp3"  ]
...
[playse  volume="100"  time="1000"  buf="0"  storage="kuizu5.mp3"  ]
[tb_start_text mode=1 ]
#みどり
残念！！！[p]
正解は、ウランバートルでした！[p]
...
[playbgm  volume="100"  time="1000"  loop="true"  storage="MusMus-BGM-093.mp3"  fadein="true"  ]
[tb_image_hide  time="1000"  ]
[tb_start_text mode=1 ]
#みどり
